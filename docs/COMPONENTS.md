...
| `CanvasBlock`      | Positioned, selectable, resizable wrapper + face. Independently exported/usable — not only rendered by `Canvas`'s own loop.                                                                                                                                                                                                                                                                                                                      | `block`, `selected` `highlighted` `editing` `resizable`, `chrome` (a `document` block's `Document.chrome` override — see below), `renderBlock`                                                                                                                                              |
